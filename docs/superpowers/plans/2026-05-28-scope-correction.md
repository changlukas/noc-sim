...
**Working dir:** `E:/05_NoC/noc-sim/.worktrees/c-model-bootstrap`. Worktree branch: `feat/c-model-bootstrap` (already 16 commits in; this plan adds ~8 more).
...
## Task 2: Phase X.2 — Codegen elaborate `<REG>_RESET` + `ALL_OFFSETS[]`
...
## Task 3: Phase X.2 — c_model RegisterFile consumes F-004 + F-005
...
## Task 4: Phase X.3 — Codegen redesign access-mode emission
...
## Task 5: Phase X.3 — c_model RegisterFile consumes AccessMode
...
## Task 6: Phase X.4 — Codegen elaborate `PADDING_FIELDS[]`
...
## Task 7: Phase X.4 — c_model Flit consume + API quarantine
...
## Task 8: Phase X.5 — `SUFFICIENCY_FINDINGS.md` final disposition
...
After all 8 tasks, run from worktree root:
